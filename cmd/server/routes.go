...
func registerRoutes(e *echo.Echo, handlers routeHandlers, membershipRepo domain.MembershipRepository) {
	...
	adminGroup.GET("/qr", handlers.Admin.GenerateQR)
	...
	dashboardGroup.POST("/menu/category", handlers.Admin.CreateMenuCategory)
	dashboardGroup.POST("/menu/item", handlers.Admin.CreateMenuItem)
	dashboardGroup.POST("/menu/item/:id/photo", handlers.Admin.UploadMenuItemPhoto)
