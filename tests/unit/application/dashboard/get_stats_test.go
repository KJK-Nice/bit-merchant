...
func TestGetDashboardStatsUseCase(t *testing.T) {
	...
	o1, _ := domain.NewOrder("o1", "1001", restaurantID, items, 1000, domain.PaymentMethodTypeCash)
	o1.FiatAmount = 10.0
	...
	o2, _ := domain.NewOrder("o2", "1002", restaurantID, items, 2000, domain.PaymentMethodTypeCash)
	o2.FiatAmount = 20.0
	...
	o3, _ := domain.NewOrder("o3", "1003", restaurantID, items, 5000, domain.PaymentMethodTypeCash)
	o3.FiatAmount = 50.0
	...
	o4, _ := domain.NewOrder("o4", "1004", restaurantID, items, 500, domain.PaymentMethodTypeCash)
	o4.FiatAmount = 5.0
